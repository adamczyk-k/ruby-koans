...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Alone - probably never, with other matches - if they will fail, e.q
    # assert_equal nil, "abbcccddddeeeee"[/z*1]
  end
  ...
  # Why?
  #
  # Because it tries to match the most it can and if it will fail
  # it will backtrack to match shorter fragment
