...
class AboutSymbols < Neo::Koan
  ...
  #
  # Because converting String to Symbol will add it to list of all symbols
  # and it wasn't our goal
  ...
  #
  # Because they will exist to the end of program, so you can't free memory
end
